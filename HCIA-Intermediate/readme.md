...
Pada bagian pembelajaran ini, kita akan membahas  topik  intermediate terkait konfigurasi di Huawei Router, antara lain:

- **Link Aggregation** 
- **VLAN & InterVLAN** 
- **WAN**  
- **Traffic Filtering & NAT**  

---

## Metode Pembelajaran

Di section ini, sama seperti sebelumnya kita akan lebih banyak **berfokus pada lab skenario** dan penjelasan dari hasil pengerjaan lab.  
